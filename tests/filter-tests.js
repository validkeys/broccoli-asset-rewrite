...
function confirmOutput(actualPath, expectedPath) {
  ...
  assert.deepEqual(
    actualFiles,
    expectedFiles,
    'files output should be the same as those input'
  )
  ...
  expectedFiles.forEach(function (relativePath) {
    ...
    var actual = fs.readFileSync(path.join(actualPath, relativePath), {
      encoding: 'utf8'
    })
    var expected = fs.readFileSync(path.join(expectedPath, relativePath), {
      encoding: 'utf8'
    })
    ...
    assert.equal(
      actual,
      expected,
      relativePath + ': does not match expected output'
    )
  })
}
...
describe('broccoli-asset-rev', function () {
    ...
    var node = AssetRewrite(sourcePath + '/input', {
      assetMap: {
        ...
        'fonts/OpenSans/Light/OpenSans-Light.eot':
          'fonts/OpenSans/Light/fingerprinted-OpenSans-Light.eot',
        'fonts/OpenSans/Light/OpenSans-Light.woff':
          'fonts/OpenSans/Light/fingerprinted-OpenSans-Light.woff',
        'fonts/OpenSans/Light/OpenSans-Light.ttf':
          'fonts/OpenSans/Light/fingerprinted-OpenSans-Light.ttf',
        'fonts/OpenSans/Light/OpenSans-Light.svg':
          'fonts/OpenSans/Light/fingerprinted-OpenSans-Light.svg',
        'fonts/OpenSans/Medium/OpenSans-Medium.eot':
          'fonts/OpenSans/Medium/fingerprinted-OpenSans-Medium.eot',
        'fonts/OpenSans/Medium/OpenSans-Medium.woff':
          'fonts/OpenSans/Medium/fingerprinted-OpenSans-Medium.woff',
        'fonts/OpenSans/Medium/OpenSans-Medium.ttf':
          'fonts/OpenSans/Medium/fingerprinted-OpenSans-Medium.ttf',
        'fonts/OpenSans/Medium/OpenSans-Medium.svg':
          'fonts/OpenSans/Medium/fingerprinted-OpenSans-Medium.svg'
      }
    })
  ...
  it('ignore.assets option tell filter what files should not be processed', function () {
  ...
  it('handles JavaScript files in a reasonable amount of time', function () {
    ...
    var node = new AssetRewrite(sourcePath + '/input', {
      assetMap: JSON.parse(
        fs.readFileSync(__dirname + '/fixtures/js-perf/asset-map.json')
      ),
      replaceExtensions: ['js']
    })
